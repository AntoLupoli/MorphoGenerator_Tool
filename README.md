...
**MorphoGenerator Tool** is an scientific desktop application for the **real-time CFD visualization**, parametric analysis, morphological design, and 3D exploration of **MorphoGenerator**  device.
...
- Interactive **3D Viewer** for inspecting internal geometry and flow channels.
...
- **Forward Design Mode**:
  ...
  - Dynamic side inlet configuration: select number of peripheral inlets (0 to 10), angular width (theta), angular rotation (0° - 360°), and spacing distribution.
...
### 3. Correlation Plots
- Choose different variables to plot.
...
To generate a standalone, single-file Windows executable with embedded assets and custom icon (or download it directly from Releases):
...
If you use **MorphoGenerator Tool** or its morphological correlation models in your research, please cite the reference paper:

> **Morphogeneration: Continuous chaotic flow of flower-shape microstructures**  
> *Chemical Engineering Journal*  
> 🔗 **Paper Link**: [ScienceDirect Article](https://www.sciencedirect.com/science/article/pii/S1385894726047418)
